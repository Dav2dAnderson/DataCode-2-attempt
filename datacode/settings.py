"""
Django settings for datacode project.
...
SECRET_KEY = 'django-insecure-!%nq-xaa59*ue2q=n28r@j1ms6%e&xniy38nv-t*!f^_l3vl%k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["datacode-2-attempt.onrender.com", '127.0.0.1']
...
WSGI_APPLICATION = 'datacode.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), # JWT token muddati
